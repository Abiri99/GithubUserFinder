...
class GithubSearchResponseJsonAdapterTest {
    ...
    fun whenCreateEntityFromJson_thenReturnProperEntity() {
        ...
        val fakeGithubSearchItem = GithubSearchItem(
            id = 100,
            login = "JakeWharton",
        ...
        assertThat(expectedResult.items.size).isEqualTo(1)
        assertThat(expectedResult.items.first()).isEqualTo(fakeGithubSearchItem)
    }
}
